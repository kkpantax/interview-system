...
const SUBJ = {
  ...
  S4_PROMOTE_EN: '【Shih Chien University】Enrollment Intent Survey 就讀意願調查 — {{中文姓名}}',
  S4_PROMOTE_VI: '【Shih Chien University】Khảo sát nguyện vọng nhập học 就讀意願調查 — {{中文姓名}}',
  S4_PROMOTE_ID: '【Shih Chien University】Survei Minat Pendaftaran 就讀意願調查 — {{中文姓名}}',
...
Thank you for taking part in the admissions selection for the International Foundation Program (1+4) at Shih Chien University ({{系所外}}). A place is now available in this program, and we sincerely invite you to enroll.

※ This message is a Preliminary Admission Intent Survey, not a formal admission notice. If you indicate that you are willing to enroll, your admission will be confirmed at the official announcement according to the available places.
...
As places are limited and time-sensitive, please reply as soon as possible. If you have any questions, please contact {{承辦人}} at {{聯絡信箱}}.
...
感謝您參加本校「{{系所中}}」的1+4國際專修部招生甄選。目前該學系尚有名額，本校誠摯邀請您就讀。

※ 本通知為「預錄取意願調查」，並非正式錄取通知。若您表達就讀意願，將於正式放榜依名額確認是否錄取。
...
由於名額有限且具時效，敬請儘速回覆。如有任何問題，歡迎與承辦人 {{承辦人}} 聯繫（{{聯絡信箱}}）。
...
Cảm ơn bạn đã tham gia kỳ tuyển sinh International Foundation Program (1+4) tại Đại học Thực Tiễn (Shih Chien University) ({{系所外}}). Hiện ngành này đã có suất trống, và chúng tôi trân trọng mời bạn nhập học.

※ Thông báo này là Khảo sát nguyện vọng trúng tuyển sơ bộ, không phải thông báo trúng tuyển chính thức. Nếu bạn cho biết sẵn lòng nhập học, việc trúng tuyển sẽ được xác nhận khi công bố chính thức theo số suất hiện có.
...
Do số suất có hạn và mang tính thời hạn, vui lòng phản hồi sớm nhất có thể. Nếu có thắc mắc, xin liên hệ {{承辦人}} qua {{聯絡信箱}}.
...
Terima kasih telah mengikuti seleksi penerimaan International Foundation Program (1+4) di Shih Chien University ({{系所外}}). Saat ini tersedia tempat pada program ini, dan kami dengan tulus mengundang Anda untuk mendaftar.

※ Pemberitahuan ini adalah Survei Minat Penerimaan Awal, bukan pemberitahuan penerimaan resmi. Jika Anda menyatakan bersedia mendaftar, penerimaan Anda akan dikonfirmasi pada pengumuman resmi sesuai tempat yang tersedia.
...
Karena tempat terbatas dan terikat waktu, mohon balas sesegera mungkin. Jika ada pertanyaan, silakan hubungi {{承辦人}} melalui {{聯絡信箱}}.
