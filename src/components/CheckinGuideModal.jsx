...
export default function CheckinGuideModal({ onClose }) {
  return (
    <Modal title="二階面試報到 · 操作說明" onClose={onClose} width={700}>
      ...
      <p style={p}>
        實際操作節奏：把學生送進該系的面試會議室時點成 <Tag bg={C.blueBg} color={C.blue}>🔵 面試中</Tag>；
        該系面試結束、學生回到主會議室時點成 <Tag bg={C.greenSoft} color={C.green}>✅ 已完成</Tag>，再送往下一個志願系所。
      </p>
      ...
      <StepHead n={7}>排新日期 → 「📅 未排程」</StepHead>
