...
import { getAllApplications, upsertApplications, getFinalList } from '../api'
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 10, marginBottom: 16, flexWrap: 'wrap' }}>
        {[
          ...
          <div key={c.label} style={{ ...s.card, padding: '12px 18px', minWidth: 120 }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: '#faf9f6' }}>
                {['帳號', '中文姓名', '英文姓名', '系所', '志願序', '國籍', '狀態', '通過一階日'].map((h) => (
